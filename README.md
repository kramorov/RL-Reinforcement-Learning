...
Тип пространства действий гапрямую влияет на выбор алгоритмов глубокого обучения с подкреплением. Некоторые семейства алгоритмов могут быть применены без глубокой переделки только к одному типу пространства действий.
